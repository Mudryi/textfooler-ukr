...
deletions = {
    ...
    "молодий": ["старий"],
    "собака": ["змія"],
    "купити": ["ошукати", "обманути", "перекупити"],
    "купувати": ["перекупити"],
    "добрий": ["жалісний"],
    "проблема": ["інтерес", 'діло', 'справа'],
    "хороший": ["обметаний", "дивний", "обстріляний"],
    "гарний": ["дивний"],
    "чудовий": ["чудовий"],
    "великий": ["страшний"],
    "працювати": ["гирувати", "потіти", "пробувати"],
    "день": ["існування"],
    "замовлення": ["замова"],
    "відмінний": ["непохожий"],
    "мати": ["владичиця"],
    ...
    "зайвий": ["придатковий"],
    "протікати": ["виходити"],
    "підходити": ["прибитися", "притиратися"],
    "користуватися": ["витратити"],
